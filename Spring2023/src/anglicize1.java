...
public class anglicize1 {
   ...
   public static String anglicize1(int n) {
      ...
      if (n < 10000000)
         ...
         s = anglicize2(n/10000000) + "thousand " + anglicize2(n%10000000);
   ...
   public static String anglicize2(int n) {
      ...
      if (n < 1000000)
         ...
         s = anglicize3(n/1000000) + "thousand " + anglicize2(n%1000000); 
   ...
   public static String anglicize4(int n) {
      ...
      if (n < 10000)
         ...
         s = anglicize5(n/10000) + "thousand " + anglicize5(n%10000);
   ...
   public static String anglicize5(int n) {
      ...
      if (n < 1000)
         ...
         s = anglicize6(n/1000) + "thousand " + anglicize6(n%1000);
   ...
   public static String anglicize6(int n) {
      ...
      if (n < 100)
         ...
         s = digitName(n/100) + "hundred " + anglicize7(n%100);
