...
public class anglicizetest {
   ...
   public static String anglicize1(int n) {
      ...
      if (n < 100000000)
         ...
         s = anglicize2(n/100000000) + "hundred " + anglicize2(n%100000000);
   ...
   public static String anglicize2(int n) {
      ...
      if (n < 10000000)
         ...
         s = digitName(n/10000000) + "million " + anglicize3(n%10000000);
   ...
   public static String anglicize3(int n) {
      ...
      if (n < 1000000)
         ...
         s = anglicize4(n/1000000) + "million " + anglicize4(n%1000000);

      return s;
   }
  
   // Returns the english equivalent of n, for 0 < n < 1000
   public static String anglicize4(int n) {
      String s;

      if (n < 100000)
         s = anglicize5(n);
      else
         s = digitName(n/100000) + "thousand " + anglicize5(n%100000);

      return s;
   }
   
   // Returns the english equivalent of n, for 0 < n < 1000000
   public static String anglicize5(int n) {
      String s;

      if (n < 10000)
         s = anglicize6(n);
      else
         s = anglicize6(n/10000) + "thousand " + anglicize6(n%10000);

      return s;
   }
  
   // Returns the english equivalent of n, for 0 < n < 1000000
   public static String anglicize6(int n) {
      String s;

      if (n < 1000)
         s = anglicize7(n);
      else
         s = anglicize7(n/1000) + "thousand " + anglicize6(n%1000);
   ...
   public static String anglicize7(int n) {
      ...
      if (n < 100)
         ...
         s = digitName(n/100) + "hundred " + anglicize8(n%100);

      return s;
   }
   
   // Returns the english equivalent of n, for 0 < n < 100
   public static String anglicize8(int n) {
      String s;
