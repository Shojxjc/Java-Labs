...
public abstract class AbstractPriorityQueue<K,V> implements PriorityQueue<K,V> {
  ...
  protected int compare(Entry<K,V> a, Entry<K,V> b) {
    Order aOrder = (Order) a.getValue();
    Order bOrder = (Order) b.getValue();
    if( Integer.compare(aOrder.getPrice(), bOrder.getPrice()) == 0){
      return Integer.compare(aOrder.getTime(), aOrder.getTime());
    }
